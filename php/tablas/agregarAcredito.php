...
<div class="">
  <div class="float-left">
    <button class="btn btn-light btn-sm" id="btn crear_cuenta" data-bs-toggle="modal" data-bs-target="#modalCuentaNueva">
      Crear cuenta
    </button>
  </div>
  <table class="table table-bordered table-striped table-dark" id="cuenta_cre" style="width: 100%;">
    <thead>
