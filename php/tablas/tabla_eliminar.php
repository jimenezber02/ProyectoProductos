...
?>
<div>
    <button onclick="eliminaDatos(-1);" class="btn btn-danger" style="float:right;">Eliminar todos</button>
    ...
    <table class="table table-hover table-condensed table-bordered" id="datatable" style="width: 100%;">
        ...
        <tbody>
            ...
            <tr>
                ...
                <th> <button onclick="eliminaDatos('<?php echo($i[0]); ?>');" class="btn btn-danger" ><!---->
...
<script>
    $(document).ready(function(){
        $('#datatable').DataTable({
            ...
            buttons:[
                {
                    extend: 'excelHtml5',titleAttr: 'Exportar a excel',className: 'btn btn-success',
